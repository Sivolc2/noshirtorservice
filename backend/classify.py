...
for image in imagePaths:
	...
	df.loc[number] = [colorLabel, categoryLabel, get_complementary(webcolors.name_to_hex(colorLabel))]
	number += 1
	...
	#python3 classify.py --model output/fashion.model --categorybin output/category_lb.pickle --colorbin output/color_lb.pickle --image examples/black_dress.jpg
